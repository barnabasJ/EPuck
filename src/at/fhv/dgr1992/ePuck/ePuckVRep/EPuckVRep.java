...
/**
 * The class "EPuckVRep" encapsulates the ePuck robot in a scene of the VRep simulator for a
 * controller: it represents a proxy of the ePuck for the controller.
 */
public class EPuckVRep extends EPuck {
  ...
  /**
   * Creates a new instance of the EPuckVRep in asynchronous mode and with a max velocity of maxVel
   * = (120 * Math.PI / 180).
   *
   ...
   */
  public EPuckVRep(
      String robotName, String ipAddress, int port, double maxVelocity, boolean synchronous) {
  ...
  public boolean connect() throws RobotFunctionCallException {
    ...
    if (_clientID != -1) {
      ...
      // simxGetStringSignal requires a signal value, as _allSens and _camera doesn't need a value
      // just send an empty string
      synchronized (lockAPI) {
        _vrepRemote.simxGetStringSignal(
            _clientID, _signalName + "_allSens", str, _vrepRemote.simx_opmode_streaming);
        _vrepRemote.simxGetStringSignal(
            _clientID, _signalName + "_camera", str, _vrepRemote.simx_opmode_streaming);
      }
      ...
      synchronized (lockAPI) {
        _vrepRemote.simxGetStringSignal(
            _clientID, _signalName + "_velocities", str, _vrepRemote.simx_opmode_streaming);
      }
  ...
  /**
   * Initialisation of the simulation. Getting wheel diameter and wheel distance from VRep and
  ...
  private void getWheelDiameterForRemote() throws RobotFunctionCallException {
    ...
    synchronized (lockAPI) {
      ...
      returnCode =
          _vrepRemote.simxCallScriptFunction(
              _clientID,
              _robotName,
              _vrepRemote.sim_scripttype_childscript,
              "getWheelDiameterForRemote",
              null,
              null,
              null,
    ...
    if (returnCode == _vrepRemote.simx_return_ok) {
      ...
      throw new RobotFunctionCallException(
          "Getting wheel diameter failed. Return code msg from VRep: " + returnCodeDescriptions);
    }
  }
  ...
  private void getWheelDistanceForRemote() throws RobotFunctionCallException {
    ...
    if (returnCode == _vrepRemote.simx_return_ok) {
      ...
      throw new RobotFunctionCallException(
          "Getting wheel distance failed. Return code msg from VRep: " + returnCodeDescriptions);
    }
  }
  ...
  private void setMaxVelocityForRemote(double maxVelocity) throws RobotFunctionCallException {
    ...
    if (returnCode != _vrepRemote.simx_return_ok) {
      ...
      throw new RobotFunctionCallException(
          "Setting max velocity failed. Return code msg from VRep: " + returnCodeDescriptions);
    }
  }
  // endregion
   ...
   */
  @Override
  protected double[] refreshProximitySensorValues()
      throws SensorNotEnabledException, RobotFunctionCallException {
    ...
    if (returnCode == _vrepRemote.simx_return_ok) {
      ...
      throw new RobotFunctionCallException(
          "Refreshing proximity sensor values failed. Return code msg from VRep: "
              + returnCodeDescriptions);
    }
  }
   ...
   */
  @Override
  protected double[] refreshGroundSensorValues()
      throws SensorNotEnabledException, RobotFunctionCallException {
    ...
    if (returnCode == _vrepRemote.simx_return_ok) {
      ...
      throw new RobotFunctionCallException(
          "Refreshing ground sensor values failed. Return code msg from VRep: "
              + returnCodeDescriptions);
    }
  }
   ...
   */
  @Override
  protected Acceleration refreshAccelerometerValues()
      throws SensorNotEnabledException, RobotFunctionCallException {
    ...
    if (returnCode == _vrepRemote.simx_return_ok) {
      return new Acceleration(
          new double[] {outFloat.getArray()[0], outFloat.getArray()[1], outFloat.getArray()[2]});
    } else {
      VRepReturnCode[] vRepReturnCode = VRepReturnCode.defineReturnCode(returnCode);
      ...
      throw new RobotFunctionCallException(
          "Refreshing accelerometer value failed. Return code msg from VRep: "
              + returnCodeDescriptions);
    }
  }
   ...
   */
  @Override
  protected WheelEncode refreshWheelEncodingValues()
      throws SensorNotEnabledException, RobotFunctionCallException {
    ...
    if (returnCode == _vrepRemote.simx_return_ok) {
      ...
      throw new RobotFunctionCallException(
          "Refreshing wheel encoding value failed. Return code msg from VRep: "
              + returnCodeDescriptions);
    }
  }
  ...
  protected Pose refreshPose() throws SensorNotEnabledException, RobotFunctionCallException {
    ...
    if (returnCode == _vrepRemote.simx_return_ok) {
      ...
      throw new RobotFunctionCallException(
          "Refreshing pose failed. Return code msg from VRep: " + returnCodeDescriptions);
    }
  }
   ...
   */
  @Override
  protected CameraImage refreshCameraImage()
      throws CameraNotEnabledException, RobotFunctionCallException {
    if (!_cameraEnabled) {
    ...
    if (returnCode == _vrepRemote.simx_return_ok) {
      ...
      for (int y = 0; y < _imageHeight; y++) {
        for (int x = 0; x < _imageWidth; x++) {
          // The values from V-REP are between 0 and 1 so it is necessary to multiply with 255 to
          ...
          // Set the pixel with the corresponding colour. The image returned from V-REP is
          // up-side-down so and with "(_imageHeight - 1) - y" this is corrected so the image has
      ...
      throw new RobotFunctionCallException(
          "Refreshing camera image failed. Return code msg from VRep: " + returnCodeDescriptions);
    }
  }
  ...
  public boolean setImageCycle(int imageCycle) throws RobotFunctionCallException {
    ...
    if (returnCode == _vrepRemote.simx_return_ok) {
      ...
      throw new RobotFunctionCallException(
          "setImageCycle failed. Return code msg from VRep: " + returnCodeDescriptions);
    }
  }
  ...
  public boolean senseAllTogether() throws RobotFunctionCallException {
    ...
    synchronized (lockAPI) {
      returnCode =
          _vrepRemote.simxGetStringSignal(
              _clientID, _signalName + "_allSens", inCharWA, _vrepRemote.simx_opmode_buffer);
    }
    // Check if successful
    if (returnCode == _vrepRemote.simx_return_ok) {
      ...
      throw new RobotFunctionCallException(
          "fastSensingOverSignal failed. Return code msg from VRep: " + returnCodeDescriptions);
    }
  }
  ...
  /**
   * To be called from a controller when we initialized with synchronous=True. Starts the simulation
   * in synchronous mode to achieve exact simulation independent of the frame rate. One step is
   * performed.
   *
  ...
  public void startsim()
      throws SynchrounusModeNotActivatedException, RobotFunctionCallException,
          StepSimNotPossibleException {
    if (!_synchronous) {
      throw new SynchrounusModeNotActivatedException(
          "Startsim requires the synchronous mode to have been set in the init method");
    }
    synchronized (lockAPI) {
      ...
      if (returnCode != _vrepRemote.simx_return_ok) {
        ...
        throw new RobotFunctionCallException(
            "SimxStartSimulation failed. Return code msg from VRep: " + returnCodeDescriptions);
      }
      ...
      if (returnCode != _vrepRemote.simx_return_ok) {
        ...
        throw new RobotFunctionCallException(
            "SimxSynchronous failed. Return code msg from VRep: " + returnCodeDescriptions);
      }
      stepsim(1);
    }
  }
  ...
  /**
   * Perform the specified number of steps in the simulator. Requires the instance to be initialized
   * in synchronous mode.
   *
   ...
   * @throws RobotFunctionCallException
   */
  public void stepsim(int steps)
      throws SynchrounusModeNotActivatedException, StepSimNotPossibleException,
          RobotFunctionCallException {
    if (!_synchronous) {
      throw new SynchrounusModeNotActivatedException(
          "Startsim requires the synchronous mode to have been set in the init method.");
    }
    synchronized (lockAPI) {
      if (_hasOwnCameraThread || _hasOwnSensingThread) {
        throw new StepSimNotPossibleException(
            "Stepsim is incompatible with sensing or camera threads.");
      }
      ...
      for (int i = 0; i < steps; i++) {
        ...
        if (returnCode != _vrepRemote.simx_return_ok) {
          ...
          throw new RobotFunctionCallException(
              "Triggering single simulation step(SimxSynchronousTrigger) failed. Return code msg from VRep: "
                  + returnCodeDescriptions);
        }
      }
    }
   ...
   */
  @Override
  public boolean setMotorSpeeds(Speed speed)
    ...
    //         throw new VelocityLimitException("velocity: " + speed.getLeft() + ", " +
    // speed.getLeft() +"-" + _maxVel + " => velocity <= " + _maxVel);
    //      }
    ...
    if (returnCode == _vrepRemote.simx_return_ok) {
      ...
      throw new RobotFunctionCallException(
          "setMotorSpeeds left="
              ...
              + " right="
              + speed.getRight()
              + " failed. Return code msg from VRep: "
              + returnCodeDescriptions);
    }
  }
}
